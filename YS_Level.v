...
module YS_Level(
    ...
    //-------------------------------------------------------------------------
    wire state_active;
    assign state_active = (state == 3'b001) ? 1 : 0;
    wire filtered_reset;
    assign filtered_reset = (state_active) ? rst : 1;
    ...
    // Clock Generation
    //-------------------------------------------------------------------------
    Clock_Divider (clk_100MHz, filtered_reset, 7, clk_6p25MHz);
    ...
    // --- PS/2 Mouse Controller ---
     MouseCtl mouse_control (
        .clk(clk_100MHz),
        .rst(filtered_reset), // Connect system reset now
